...
(setq webjump-sites
      ...
      ("Fire" . "http://www.fs.fed.us/r3/fire/webdaily/swaintnn.htm")
...
(setq user-mail-address "kbisset@lanl.gov")
(defun krb-mailaddress-lanl()
  (interactive)
  (setq user-mail-address "kbisset@lanl.gov")
)
(defun krb-mailaddress-jemez()
  (interactive)
  (setq user-mail-address "kbisset@jemez.com")
)
(add-hook 'mail-setup-hook 'mail-abbrevs-setup)
(load-library "krb-mailaliases")
;(require 'mime-setup)
(setq gnus-secondary-select-methods '((nnml "private") (nntp "News.CIS.DFN.DE"))
...
(load "mail-split.el")
 ...
 ;;(setq mail-aliases '(
 ;;                    (rob-lanl . "rob@xdiv.lanl.gov")
 ;;                    (rob-nmsu . "rklsey@cs.nmsu.edu")
 ;;))
...
;;         rmime
       ...
       gnus-ignored-headers "^Path:\\|^Posting-Version:\\|^Article-I.D.:\\|^Expires:\\|^Date-Received:\\|^References:\\|^Control:\\|^Xref:\\|^Lines:\\|^Posted:\\|^Relay-Version:\\|^Message-ID:\\|^Nf-ID:\\|^Nf-From:\\|^Approved:\\|^Sender:\\|^Received:\\|^Mail-from:\\|^X-.*:\\|^Return-Path:\\|^Resent-.*:\\|^Encoding:\\|^Message-Id:\\|^Precedence:\\|^Resent-Sender:\\|.*Reply-To:\\|Content-.*:\\|Mime-.*:\\|^Original-.*:\\|^List-.*:\\|NNTP-.*:\\|Errors-To:\\|User-Agent:"
)
...
(setq diary-mail-days 7 
      ...
      diary-mail-addr "kbisset@lanl.gov" )
...
;;  '(gnus-summary-highlight (quote (((= mark gnus-canceled-mark) . gnus-summary-cancelled-face) ((and ... ...) . gnus-summary-high-ticked-face) ((and ... ...) . gnus-summary-low-ticked-face) ((or ... ...) . gnus-summary-normal-ticked-face) ((and ... ...) . gnus-summary-high-ancient-face) ((and ... ...) . gnus-summary-low-ancient-face) ((= mark gnus-ancient-mark) . gnus-summary-normal-ancient-face) ((and ... ...) . gnus-summary-high-unread-face) ((and ... ...) . gnus-summary-low-unread-face) ((= mark gnus-unread-mark) . gnus-summary-normal-unread-face) ((and ... ...) . gnus-summary-high-unread-face) ((and ... ...) . gnus-summary-low-unread-face) ...)))
