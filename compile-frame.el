...
;; 15-Apr-94|1.3|~/as-is/compile-frame.el|
;;
...
;;; Hack remote compile command
(cf-setup remote-compile compile-frame 
	  compilation-frame-id compilation-i-frame-id	  compilation-frame-alist compilation-frame-selected-hook)
(cf-setup-get-i-frame remote-compile compile-frame 
	  compilation-frame-id compilation-i-frame-id	  compilation-frame-alist compilation-frame-selected-hook)
(cf-setup-follow-messages remote-compile compile-frame 
	  compilation-frame-id compilation-i-frame-id	  compilation-frame-alist compilation-frame-selected-hook)
