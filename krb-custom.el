...
(custom-set-variables
 ...
 '(TeX-mode-hook (quote ((lambda nil (setq hier-imenu-levels (quote (("\\part" . 0) ("\\part*" . 0) ("\\chapter" . 1) ("\\chapter*" . 1) ("\\section" . 2) ("\\section*" . 2) ("\\subsection" . 3) ("\\subsection*" . 3) ("\\subsubsection" . 4) ("\\subsubsection*" . 4) ("\\paragraph" . 5) ("\\subparagraph" . 6))) hier-imenu-header-name-function (quote ydi-latex-header-name) hier-imenu-anchor-end-of-header t hier-imenu-style (quote numbered) imenu-create-index-function (quote imenu-default-create-index-function) imenu-generic-expression (quote (("Labels" "\\\\label{\\([^}]+\\)}" 1) (imenu-create-hierarchical-index))))) (lambda nil (flyspell-mode)))) t)
 ...
 '(package-archives (quote (("gnu" . "http://elpa.gnu.org/packages/") ("melpa.stable" . "http://melpa.org/packages/"))))
 '(paren-match-face (quote paren-face-match-light))
 '(paren-sexp-mode t)
 '(ps-printer-name "/Users/kbisset/tmp/emacs.ps")
 '(safe-local-variable-values (quote ((TeX-master . proposal\.tex) (visual-line-mode . t) (TeX-master . draft\.tex))))
 '(save-place t nil (saveplace))
 '(save-place-file "/Users/kbisset/.emacs.d/emacs-places")
 '(save-place-save-skipped nil)
 '(save-place-skip-check-regexp "\\`/\\(?:cdrom\\|floppy\\|mnt\\|Volumes\\|\\(?:[^@/:]*@\\)?[^@/:]*[^@/:.]:\\)")
 '(savehist-additional-variables (quote (file-name-history command-history extended-command-history frame-name-history query-replace-history read-expression-history set-variable-value-history shell-command-history yes-or-no-p-history face-name-history grep-history)))
 '(savehist-mode t)
 '(sudoku-download t)
